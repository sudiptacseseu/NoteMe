...
public class InProgressFragment extends Fragment implements OnItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        toDoViewModel.getToDosByStatus("In-progress").observe(getViewLifecycleOwner(), new Observer<List<Note>>() {
            @Override
