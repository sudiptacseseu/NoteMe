...
public class DoneFragment extends Fragment implements OnItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        toDoViewModel.getToDosByStatus("Done").observe(getViewLifecycleOwner(), new Observer<List<Note>>() {
            @Override
